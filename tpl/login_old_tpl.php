<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url('<?php echo $BANNER_CAT_URL ?>/login3.jpg') no-repeat scroll center center / cover ;">
							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="user_login('login');">Login</button>
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="email" id="email" placeholder="Your Email*" style="width:45%" readonly onfocus="this.removeAttribute('readonly');" onblur="this.setAttribute('readonly','');"/>
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											...
											<button type="button" class="fv-btn mobile_send_otp height_60px" onclick="mobile_send_otp();">Send OTP</button>
