...
<html class="no-js" lang="">
   ...
   <body class="bg-dark">
	  ...
	  <script src="<?php echo $ADMIN_JS_URL ?>/vendor/jquery-2.1.4.min.js" type="text/javascript"></script>
      <script src="<?php echo $ADMIN_JS_URL ?>/popper.min.js" type="text/javascript"></script>
      <script src="<?php echo $ADMIN_JS_URL ?>/plugins.js" type="text/javascript"></script>
      <script src="<?php echo $ADMIN_JS_URL ?>/main.js" type="text/javascript"></script>
   </body>
</html>