	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title">Colours </h4>
				   <h4 class="box-link"><a href="managecolour?mode=add">Add Colours</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								<?php } ?>
								<span class='badge badge-edit'><a href='managecolour?mode=edit&id=<?php echo $row['id']?>'>Edit</a></span>&nbsp;					
